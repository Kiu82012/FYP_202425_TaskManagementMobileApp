...
class AIChatRoom extends StatefulWidget {
  const AIChatRoom({Key? key}) : super(key: key);
...
class ApiKeyWidget extends StatelessWidget {
  ApiKeyWidget({required this.onSubmitted, Key? key}) : super(key: key); // Remove const
...
class ChatWidget extends StatefulWidget {
  const ChatWidget({required this.apiKey, Key? key}) : super(key: key);
